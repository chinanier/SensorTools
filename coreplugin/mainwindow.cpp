    ...
    m_toggleSideBarButton(new QToolButton)
{
    ...
    setWindowTitle(tr(/*"Qt Creator"*/"Camyu SensorTools"));
    if (HostOsInfo::isLinuxHost())
        QApplication::setWindowIcon(Icons::QTCREATORLOGO_BIG.icon());
    QCoreApplication::setApplicationName(QLatin1String("QtCreator"));
    QCoreApplication::setApplicationVersion(QLatin1String(CYCore::Constants::IDE_VERSION_LONG));
    QCoreApplication::setOrganizationName(QLatin1String(CYCore::Constants::IDE_SETTINGSVARIANT_STR));
