...
class CORE_EXPORT EditorManagerPlaceHolder : public QWidget
{
    Q_OBJECT
public:
    explicit EditorManagerPlaceHolder(QWidget *parent = 0, Utils::Id mode= Utils::Id());
...
public: // for tests
    ...
    static Core::Internal::EditorView * createProcessEditorView(Id cameraId,Id processID);
