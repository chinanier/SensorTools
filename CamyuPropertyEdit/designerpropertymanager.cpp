    ...
    m_spacing(-1)
{
    ...
    m_button->setIcon(/*createIconSet(QStringLiteral("resetproperty.png"))*/QIcon("resetproperty.png"));
...
{
    return /*qMetaTypeId<PropertySheetPixmapValue>()*/0;
}

int DesignerPropertyManager::designerIconTypeId()
{
    return /*qMetaTypeId<PropertySheetIconValue>()*/0;
}

int DesignerPropertyManager::designerStringTypeId()
{
    return /*qMetaTypeId<PropertySheetStringValue>()*/0;
}

int DesignerPropertyManager::designerStringListTypeId()
{
    return /*qMetaTypeId<PropertySheetStringListValue>()*/0;
}

int DesignerPropertyManager::designerKeySequenceTypeId()
{
    return /*qMetaTypeId<PropertySheetKeySequenceValue>()*/0;
}
...
QString DesignerPropertyManager::valueText(const QtProperty *property) const
{
    ...
    if (vType == QVariant::String || vType == designerStringTypeId()) {
        const QString str = (QtVariantPropertyManager::valueType(property) == QVariant::String) ? value(property).toString() : QString();
    ...
    if (vType == QVariant::StringList || vType == designerStringListTypeId()) {
        ...
        const QStringList list = v.type() == QVariant::StringList ? v.toStringList() : /*qvariant_cast<PropertySheetStringListValue>(v).value()*/QStringList();
            ...
            QWidget *parent)
{
    ...
    case QVariant::UInt: {
        ...
        ed->setValidator(new QULongLongValidator(0, UINT_MAX, ed));    // 设置输入验证器
