...
signals:
    void currentModeAboutToChange(CYCore::IMode *mode);

    // the default argument '=0' is important for connects without the oldMode argument.
    void currentModeChanged(CYCore::IMode *mode, CYCore::IMode *oldMode = 0);
...
private:
    ...
    friend class CYCore::Internal::MainWindow;
};
