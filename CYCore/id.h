...
Q_DECLARE_METATYPE(CYCore::Id)
Q_DECLARE_METATYPE(QList<CYCore::Id>)

QT_BEGIN_NAMESPACE
QDataStream &operator<<(QDataStream &ds, CYCore::Id id);
QDataStream &operator>>(QDataStream &ds, CYCore::Id &id);
QDebug operator<<(QDebug dbg, const CYCore::Id &id);
QT_END_NAMESPACE
