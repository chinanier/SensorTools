...
public:
    ...
    {
        label_8->setText(QApplication::translate("ExtensionSystem::Internal::PluginDetailsView", "Description:", 0));
        label->setText(QApplication::translate("ExtensionSystem::Internal::PluginDetailsView", "Name:", 0));
        label_3->setText(QApplication::translate("ExtensionSystem::Internal::PluginDetailsView", "Compatibility version:", 0));
        label_10->setText(QApplication::translate("ExtensionSystem::Internal::PluginDetailsView", "Dependencies:", 0));
        label_2->setText(QApplication::translate("ExtensionSystem::Internal::PluginDetailsView", "Version:", 0));
        label_4->setText(QApplication::translate("ExtensionSystem::Internal::PluginDetailsView", "Vendor:", 0));
        label_7->setText(QApplication::translate("ExtensionSystem::Internal::PluginDetailsView", "Location:", 0));
        platformsDescriptionLabel->setText(QApplication::translate("ExtensionSystem::Internal::PluginDetailsView", "Platforms:", 0));
        label_6->setText(QApplication::translate("ExtensionSystem::Internal::PluginDetailsView", "URL:", 0));
        label_11->setText(QApplication::translate("ExtensionSystem::Internal::PluginDetailsView", "Group:", 0));
        label_5->setText(QApplication::translate("ExtensionSystem::Internal::PluginDetailsView", "Copyright:", 0));
        label_9->setText(QApplication::translate("ExtensionSystem::Internal::PluginDetailsView", "License:", 0));
