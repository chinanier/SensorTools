...
public:
    ...
    {
        Utils__ProxyCredentialsDialog->setWindowTitle(QApplication::translate("Utils::ProxyCredentialsDialog", "Proxy Credentials", 0));
        infotext->setText(QApplication::translate("Utils::ProxyCredentialsDialog", "The proxy %1 requires a username and password.", 0));
        usernameLabel->setText(QApplication::translate("Utils::ProxyCredentialsDialog", "Username:", 0));
        usernameLineEdit->setPlaceholderText(QApplication::translate("Utils::ProxyCredentialsDialog", "Username", 0));
        passwordLabel->setText(QApplication::translate("Utils::ProxyCredentialsDialog", "Password:", 0));
        passwordLineEdit->setPlaceholderText(QApplication::translate("Utils::ProxyCredentialsDialog", "Password", 0));
    } // retranslateUi
