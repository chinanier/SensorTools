...
public:
    ...
    {
        Utils__ProjectIntroPage->setTitle(QApplication::translate("Utils::ProjectIntroPage", "Introduction and Project Location", 0));
        nameLabel->setText(QApplication::translate("Utils::ProjectIntroPage", "Name:", 0));
        pathLabel->setText(QApplication::translate("Utils::ProjectIntroPage", "Create in:", 0));
        projectsDirectoryCheckBox->setText(QApplication::translate("Utils::ProjectIntroPage", "Use as default project location", 0));
        projectLabel->setText(QApplication::translate("Utils::ProjectIntroPage", "Project:", 0));
    } // retranslateUi
