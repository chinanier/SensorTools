...
public:
    ...
    {
        Utils__WizardPage->setTitle(QApplication::translate("Utils::WizardPage", "Choose the Location", 0));
        nameLabel->setText(QApplication::translate("Utils::WizardPage", "Name:", 0));
        pathLabel->setText(QApplication::translate("Utils::WizardPage", "Path:", 0));
    } // retranslateUi
