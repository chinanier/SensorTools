...
public:
    ...
    {
        classNameLabel->setText(QApplication::translate("Utils::NewClassWidget", "&Class name:", 0));
        baseClassLabel->setText(QApplication::translate("Utils::NewClassWidget", "&Base class:", 0));
        classTypeLabel->setText(QApplication::translate("Utils::NewClassWidget", "&Type information:", 0));
        classTypeComboBox->clear();
        classTypeComboBox->insertItems(0, QStringList()
         << QApplication::translate("Utils::NewClassWidget", "None", 0)
         << QApplication::translate("Utils::NewClassWidget", "Inherits QObject", 0)
         << QApplication::translate("Utils::NewClassWidget", "Inherits QWidget", 0)
         << QApplication::translate("Utils::NewClassWidget", "Inherits QDeclarativeItem - Qt Quick 1", 0)
         << QApplication::translate("Utils::NewClassWidget", "Inherits QQuickItem - Qt Quick 2", 0)
         << QApplication::translate("Utils::NewClassWidget", "Based on QSharedData", 0)
        );
        headerLabel->setText(QApplication::translate("Utils::NewClassWidget", "&Header file:", 0));
        sourceLabel->setText(QApplication::translate("Utils::NewClassWidget", "&Source file:", 0));
        generateFormLabel->setText(QApplication::translate("Utils::NewClassWidget", "&Generate form:", 0));
        generateFormCheckBox->setText(QString());
        formLabel->setText(QApplication::translate("Utils::NewClassWidget", "&Form file:", 0));
        pathLabel->setText(QApplication::translate("Utils::NewClassWidget", "&Path:", 0));
